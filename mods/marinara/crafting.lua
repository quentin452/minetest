...
doors.register_trapdoor("marinara:metal_trapdoor", {
	description = S"Metal Ship Trapdoor",
	inventory_image = "marinara_metal_trapdoor.png",
	wield_image = "marinara_metal_trapdoor.png",
	tile_front = "marinara_metal_trapdoor.png",
	tile_side = "marinara_metal_trapdoor_side.png",
	gain_open = 0.06,
	gain_close = 0.13,
...
minetest.register_craft({
	output = "marinara:metal_trapdoor 2",
	recipe = {
		{"default:steel_ingot", "default:steel_ingot", "default:steel_ingot"},
		{"marinara:seapocks", "xpanes:pane_flat", "default:steel_ingot"},
	}
})

doors.register("marinara:metal_door", {
    tiles = {{ name = "marinara_metal_door.png", backface_culling = true }},
    description = S"Metal Ship Door",
    inventory_image = "marinara_item_metal_door.png",
    gain_open = 0.06,
    gain_close = 0.13,
	sounds = default.node_sound_metal_defaults( ),
	sound_open = "doors_steel_door_open",
...
minetest.register_craft({
	output = "marinara:metal_door",
	recipe = {
		{"default:steel_ingot", "default:steel_ingot"},
		{"xpanes:pane_flat", "xpanes:pane_flat"},
		{"marinara:seapocks", "default:steel_ingot"},
	} 
})

doors.register_trapdoor("marinara:nautic_trapdoor", {
	description = S"Nautic Trapdoor",
	inventory_image = "marinara_nautic_trapdoor.png",
	wield_image = "marinara_nautic_trapdoor.png",
	tile_front = "marinara_nautic_trapdoor.png",
	tile_side = "marinara_nautic_trapdoor_side.png",
...
minetest.register_craft({
	output = "marinara:nautic_trapdoor 2",
	recipe = {
		{"group:wood", "group:wood", "default:gold_ingot"},
		{"marinara:seapocks", "xpanes:pane_flat", "group:wood"},
	}
})

doors.register("marinara_nautic_door", {
    tiles = {{ name = "marinara_nautic_door.png", backface_culling = true }},
    description = S"Nautic Door",
    inventory_image = "marinara_item_nautic_door.png",
    groups = {node = 1, choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
    gain_open = 0.06,
    gain_close = 0.13,
	recipe = {
		{"group:wood", "group:wood"},
		{"xpanes:pane_flat", "default:gold_ingot"},
		{"marinara:seapocks", "group:wood"},
	} 
})

doors.register_trapdoor("marinara:wooden_trapdoor", {
	description = S"Wooden Trapdoor",
	inventory_image = "marinara_wooden_trapdoor.png",
	wield_image = "marinara_wooden_trapdoor.png",
	tile_front = "marinara_wooden_trapdoor.png",
	tile_side = "marinara_wooden_trapdoor_side.png",
    groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2, door = 1},
	gain_open = 0.06,
	gain_close = 0.13,
...
minetest.register_craft({
	output = "marinara:wooden_trapdoor 2",
	recipe = {
...
doors.register("marinara_wooden_door", {
    tiles = {{ name = "marinara_wooden_door.png", backface_culling = true }},
    description = S"Wooden Door",
    inventory_image = "marinara_item_wooden_door.png",
    groups = {node = 1, choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
    gain_open = 0.06,
    gain_close = 0.13,
	recipe = {
		{"group:wood", "group:wood"},
		{"xpanes:pane_flat", "group:wood"},
		{"marinara:seapocks", "group:wood"},
	} 
})