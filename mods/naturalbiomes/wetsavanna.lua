...
bonemeal:add_sapling({
	{"naturalbiomes:acacia_sapling", grow_new_acacia_tree, "soil"},
})
end
...
if minetest.get_modpath("bonemeal") then
	bonemeal:add_deco({
		{"naturalbiomes:savannalitter", {"naturalbiomes:savannagrass", "naturalbiomes:savannagrasssmall", "naturalbiomes:savanna_flowergrass", "naturalbiomes:savanna_grass2", "naturalbiomes:savanna_grass3"}, {}}
	})
end
