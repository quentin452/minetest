...
bonemeal:add_sapling({
	{"naturalbiomes:palm_sapling", grow_new_palm_tree, "soil"},
})
end
...
if minetest.get_modpath("bonemeal") then
bonemeal:add_sapling({
	{"naturalbiomes:beach_bush_sapling", grow_new_palm_bush, "soil"},
})
end
...
if minetest.get_modpath("bonemeal") then
	bonemeal:add_deco({
		{"naturalbiomes:palmbeach_sand", {"naturalbiomes:palmbeach_grass1", "naturalbiomes:palmbeach_grass2", "naturalbiomes:palmbeach_grass3"}, {}}
	})
end
