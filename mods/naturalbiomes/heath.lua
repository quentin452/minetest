...
bonemeal:add_sapling({
	{"naturalbiomes:willow_sapling", grow_new_willow_tree, "soil"},
})
end
...
if minetest.get_modpath("bonemeal") then
bonemeal:add_sapling({
	{"naturalbiomes:juniper_sapling", grow_new_juniper_tree, "soil"},
})
end
...
if minetest.get_modpath("bonemeal") then
bonemeal:add_sapling({
	{"naturalbiomes:birch_sapling", grow_new_birch_tree, "soil"},
})
end
...
if minetest.get_modpath("bonemeal") then
	bonemeal:add_deco({
		{"naturalbiomes:heath_litter", {"naturalbiomes:heath_grass", "naturalbiomes:heath_grass2", "naturalbiomes:heath_grass3", "naturalbiomes:heatherflower", "naturalbiomes:heatherflower2", "naturalbiomes:heatherflower3", "naturalbiomes:heatherflower4", "naturalbiomes:swampgrass", "naturalbiomes:swampgrass2"}, {}}
	})
end

if minetest.get_modpath("bonemeal") then
	bonemeal:add_deco({
		{"naturalbiomes:heath_litter2", {"naturalbiomes:heath_grass", "naturalbiomes:heath_grass2", "naturalbiomes:heath_grass3", "naturalbiomes:heatherflower", "naturalbiomes:heatherflower2", "naturalbiomes:heatherflower3", "naturalbiomes:heatherflower4"}, {}}
	})
end
