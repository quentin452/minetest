...
bonemeal:add_sapling({
	{"naturalbiomes:olive_sapling", grow_new_olive_tree, "soil"},
})
end
...
if minetest.get_modpath("bonemeal") then
bonemeal:add_sapling({
	{"naturalbiomes:pine_sapling", grow_new_pine_tree, "soil"},
})
end
...
if minetest.get_modpath("bonemeal") then
bonemeal:add_sapling({
	{"naturalbiomes:med_bush_sapling", grow_new_cypress_tree, "soil"},
})
end
...
if minetest.get_modpath("bonemeal") then
	bonemeal:add_deco({
		{"naturalbiomes:mediterran_litter", {"naturalbiomes:med_flower1", "naturalbiomes:med_flower2", "naturalbiomes:med_flower3", "naturalbiomes:med_grass1", "naturalbiomes:med_grass2"}, {}}
	})
end
