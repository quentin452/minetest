...
bonemeal:add_sapling({
	{"naturalbiomes:bushland_blackberrybush_sapling", grow_new_blackberry_bush, "soil"},
})
end
...
if minetest.get_modpath("bonemeal") then
bonemeal:add_sapling({
	{"naturalbiomes:bushland_wildrosebush_sapling", grow_new_wildrose_bush, "soil"},
})
end
...
if minetest.get_modpath("bonemeal") then
bonemeal:add_sapling({
	{"naturalbiomes:bushland_hazelnutbush_sapling", grow_new_hazelnut_bush, "soil"},
})
end
...
minetest.register_craft({
	output = "naturalbiomes:hazelnut_cracked",
type = "shapeless",
	recipe = 
		{"naturalbiomes:hazelnut", "group:stone"}
})
...
if minetest.get_modpath("bonemeal") then
	bonemeal:add_deco({
		{"naturalbiomes:bushland_bushlandlitter", {"naturalbiomes:bushland_grass", "naturalbiomes:bushland_grass2", "naturalbiomes:bushland_grass3", "naturalbiomes:bushland_grass4", "naturalbiomes:bushland_grass5", "naturalbiomes:bushland_grass6", "naturalbiomes:bushland_grass7"}, {}}
	})
end

if minetest.get_modpath("bonemeal") then
	bonemeal:add_deco({
		{"naturalbiomes:bushland_bushlandlitter2", {"naturalbiomes:bushland_grass", "naturalbiomes:bushland_grass2", "naturalbiomes:bushland_grass3", "naturalbiomes:bushland_grass4", "naturalbiomes:bushland_grass5", "naturalbiomes:bushland_grass6", "naturalbiomes:bushland_grass7"}, {}}
	})
end

if minetest.get_modpath("bonemeal") then
	bonemeal:add_deco({
		{"naturalbiomes:bushland_bushlandlitter3", {"naturalbiomes:bushland_grass", "naturalbiomes:bushland_grass2", "naturalbiomes:bushland_grass3", "naturalbiomes:bushland_grass4", "naturalbiomes:bushland_grass5", "naturalbiomes:bushland_grass6", "naturalbiomes:bushland_grass7"}, {}}
	})
end