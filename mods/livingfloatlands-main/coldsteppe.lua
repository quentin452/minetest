...
bonemeal:add_sapling({
	{"livingfloatlands:coldsteppe_pine_sapling", grow_new_coldsteppe_pine_tree, "soil"},
})
end
...
if minetest.get_modpath("bonemeal") then
bonemeal:add_sapling({
	{"livingfloatlands:coldsteppe_pine2_sapling", grow_new_coldsteppe_pine2_tree, "soil"},
})
end
...
if minetest.get_modpath("bonemeal") then
bonemeal:add_sapling({
	{"livingfloatlands:coldsteppe_pine3_sapling", grow_new_coldsteppe_pine3_tree, "soil"},
})
end
...
if minetest.get_modpath("bonemeal") then
	bonemeal:add_deco({
		{"livingfloatlands:coldsteppe_litter", {"livingfloatlands:coldsteppe_grass1", "livingfloatlands:coldsteppe_shrub", "livingfloatlands:coldsteppe_grass2", "livingfloatlands:coldsteppe_grass3", "livingfloatlands:coldsteppe_grass4"}, {}}
	})
end
